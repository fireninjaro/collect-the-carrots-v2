...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Projectile, function (sprite, otherSprite) {
    ...
    mySprite8 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Switch)
    mySprite8.setPosition(80, 55)
})
info.onCountdownEnd(function () {
    game.showLongText("Level two get to the red square ", DialogLayout.Full)
})
...
game.showLongText("Level one: press A to shoot an arrow at the soldier but beware each shot costs five hearts  survive the time in the count down", DialogLayout.Full)
...
let mySprite7 = sprites.create(img`
    ...
    e e e e e e 2 2 4 4 4 4 5 4 2 2 
    `, SpriteKind.Spike)
mySprite3.setPosition(80, 55)
mySprite4.setPosition(50, 28)
mySprite5.setPosition(125, 28)
mySprite6.setPosition(130, 90)
mySprite7.setPosition(25, 90)
